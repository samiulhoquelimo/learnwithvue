          ...
          <ul class="md:fixed md:bottom-0 mb-7 flex items-center space-x-8 md:flex-col md:space-y-4 md:space-x-0">
            ...
            <li v-show="mediumLink.length"
              ...
              <a :href="mediumLink" target="_blank">
                <font-awesome-icon
                    class="h-8 w-8 md:h-12 md:w-12 text-black transition ease-out hover:-translate-y-1 motion-reduce:hover:translate-y-0 duration-300 dark:text-slate-300"
                    icon="fa-brands fa-medium"></font-awesome-icon>
              </a>
            </li>
            <li v-show="stackoverflowLink.length"
              ...
              <a :href="stackoverflowLink" target="_blank">
                <font-awesome-icon
                    class="h-8 w-8 md:h-12 md:w-12 text-black transition ease-out hover:-translate-y-1 motion-reduce:hover:translate-y-0 duration-300 dark:text-slate-300"
                    icon="fa-brands fa-stack-overflow"></font-awesome-icon>
              </a>
            </li>
          </ul>
        </div>
        <div class="col-span-4 flex-1 flex-col order-1 md:order-none">
          <div class="container mx-auto">
            ...
            <footer class="hidden text-center md:block mb-5">
              <p>💻 <a class="hover:text-link-color" href="#" target="_blank">Samiul Hoque Limo</a> 💻</p>
            </footer>
          </div>
        </div>
        <div class="hidden col-span-1 md:flex flex-initial relative order-2 text-center md:order-none">
          <p :class="['fixed bottom-2 right-10 origin-top-right rotate-90 transition-all motion-reduce:transition-none duration-500', showLanding ? 'translate-y-0 opacity-1' : '-translate-y-4 opacity-0']">
            📍 Based in {{ portfolio.greeting.basedLocation }}</p>
        </div>
        <footer class="block text-center text-sm md:hidden order-last mb-5">
          <p>🚀 Designed & Created by <a class="hover:text-link-color" href="https://github.com/samiulhoquelimo"
                                        target="_blank">Samiul Hoque Limo</a></p>
        </footer>
      </div>
    </div>
  </div>
